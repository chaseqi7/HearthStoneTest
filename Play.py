...
while pointer1 < len(d1.get_deck()) and pointer2 < len(d2.get_deck()):
    ...
    print("Player1's "+str(pointer1+1)+'th card: '+str(d1.get_deck()[pointer1].get_attack())+'/'+str(d1.get_deck()[pointer1].get_health())+' and '
          "Player2's "+str(pointer2+1)+'th card: '+str(d2.get_deck()[pointer2].get_attack())+'/'+str(d2.get_deck()[pointer2].get_health())+' are attacking!')
    ...
    if remainingHealth1 > 0:
        ...
        print("Player1's " + str(pointer1+1) + 'th card lived with '+str(d1.get_deck()[pointer1].get_health())+' health!')
    else:
    ...
    if remainingHealth2 > 0:
        ...
        print("Player2's " + str(pointer2+1) + 'th card lived with '+str(d2.get_deck()[pointer2].get_health())+' health!')
    else:
